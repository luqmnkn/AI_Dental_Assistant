...
function DentalHealthOverview() {
  const [appointmentStats, setAppointmentStats] = useState({ totalAppointments: 0, completedAppointments: 0 });
  ...
  useEffect(() => {
    Promise.all([
      ...
      .catch(() => {
        setAppointmentStats({ totalAppointments: 0, completedAppointments: 0 });
      });
  }, []);
